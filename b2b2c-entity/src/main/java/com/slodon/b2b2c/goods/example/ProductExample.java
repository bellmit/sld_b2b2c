...
/**
 * 商品表（SKU），指定特定规格example
 */
@Data
public class ProductExample implements Serializable {
    private static final long serialVersionUID = 7774966362032601815L;
    /**
     * 用于编辑时的重复判断
     */
    private Long productIdNotEquals;
    ...
    /**
     * 排序条件，条件之间用逗号隔开，如果不传则按照productId倒序排列
     */
