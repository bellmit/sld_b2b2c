...
/**
 * PC商城装修页组装信息表（基于实例化数据表组合）example
 */
@Data
public class TplPcMallDecoExample implements Serializable {
    private static final long serialVersionUID = 3600495542526453624L;
    /**
     * 用于编辑时的重复判断
     */
