...
/**
 * @program: slodon
 * @Description 阶梯满件折扣新增DTO
 * @Author wuxy
 * @date 2020.11.05 16:14
 */
@Data
public class FullNldAddDTO implements Serializable {

    private static final long serialVersionUID = 2882374667372075521L;
