 ...
 */
@Data
public class FullNumLadderDiscount implements Serializable {
    private static final long serialVersionUID = 1851404568835853002L;
    @ApiModelProperty("阶梯满件折扣活动id")
    private Integer fullId;

    @ApiModelProperty("阶梯满件折扣活动名称")
    private String fullName;

    @ApiModelProperty("阶梯满件折扣活动开始时间")
    private Date startTime;

    @ApiModelProperty("阶梯满件折扣活动结束时间")
