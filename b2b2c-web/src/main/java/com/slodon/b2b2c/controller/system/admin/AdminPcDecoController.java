...
@Api(tags = "admin-pc首页装修管理")
@RestController
@RequestMapping("v3/system/admin/pcDeco")
public class AdminPcDecoController extends BaseController {
    ...
    @GetMapping("display")
    public JsonResult<TplPcMallDecoDetailVO> display(Integer decoId) {
    ...
    public JsonResult add(HttpServletRequest request, String decoType, String decoName) {
        ...
        tplPcMallDeco.setCreateUserId(adminUser.getAdminId().longValue());
        tplPcMallDeco.setCreateUserName(adminUser.getAdminName());
        tplPcMallDeco.setCreateTime(new Date());
        tplPcMallDeco.setUpdateUserId(adminUser.getAdminId().longValue());
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "decoId", value = "装修页id", required = true),
            @ApiImplicitParam(name = "decoType", value = "装修页类型"),
            @ApiImplicitParam(name = "decoName", value = "装修页名称"),
    ...
    @OperationLogger(option = "启/停用装修页")
