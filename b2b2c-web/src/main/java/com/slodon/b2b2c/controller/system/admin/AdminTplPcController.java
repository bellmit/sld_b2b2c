...
@Api(tags = "admin-pc端装修模板管理")
@RestController
@RequestMapping("v3/system/admin/tplPc")
public class AdminTplPcController extends BaseController {
    ...
    public JsonResult updateTplData(HttpServletRequest request, Integer dataId, String name, String html, String json, Integer sort) {
        ...
        tplPcMallData.setUpdateUserId(adminUser.getAdminId().longValue());
    ...
    @OperationLogger(option = "删除实例化模板数据")
    ...
    @OperationLogger(option = "启/停用实例化模板数据")
    ...
    @OperationLogger(option = "复制实例化模板数据")
