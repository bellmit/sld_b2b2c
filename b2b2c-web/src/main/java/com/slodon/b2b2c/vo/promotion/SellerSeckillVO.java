...
/**
 * @program: slodon
 * @Description 封装秒杀活动VO对象
 */

@Data
public class SellerSeckillVO implements Serializable {

    private static final long serialVersionUID = -6488865302116972289L;
    ...
    public SellerSeckillVO(Seckill seckill) {
