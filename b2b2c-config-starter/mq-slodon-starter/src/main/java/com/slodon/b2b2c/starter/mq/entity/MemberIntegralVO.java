...
/**
 * @program: slodon
 * @Description 封装会员积分VO对象
 * @Author wuxy
 */
@Data
public class MemberIntegralVO implements Serializable {

    private static final long serialVersionUID = -7644196078458482333L;
    ...
    @ApiModelProperty("关联code，根据opt_type判断字段值意义，3-订单sn，4-订单货品明细ID，7-订单sn，8-订单货品明细ID，11-订单sn，12-订单货品明细ID，13-订单sn")
    private String refCode;

    @ApiModelProperty("操作人ID(记录管理员id)")
    private Integer optId;

    @ApiModelProperty("操作人名称(记录管理员名称)")
    private String optName;

    public MemberIntegralVO(Integer memberId, String memberName, Integer value, Integer type, String description,
                            String refCode, Integer optId, String optName) {
